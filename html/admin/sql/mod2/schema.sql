...
ALTER FUNCTION public.plpgsql_call_handler() OWNER TO dany;

--
-- Name: plpgsql_validator(oid); Type: FUNCTION; Schema: public; Owner: dany
--
...
ALTER FUNCTION public.plpgsql_validator(oid) OWNER TO dany;
...
ALTER FUNCTION public.plpython_call_handler() OWNER TO dany;
