...
?>
   function toggleShow(p_but,p_msg_show,p_msg_hide,p_div) {
	try {var detail=g(p_div);	
	     if (detail.style.display=='block' ) { $(p_but).value=p_msg_show;detail.style.display='none';}
	     else { $(p_but).value=p_msg_hide;detail.style.display='block';} }
